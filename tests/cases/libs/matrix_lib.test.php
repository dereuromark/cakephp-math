 ...
 * 2009-07-15 ms
 */
class MatrixLibCase extends CakeTestCase {
	var $Matrix = null;
	
	var $examples5x5 = array(
		array(1, 2, 3, 2, 1),
		array(4, 1, 2, 4, 2),
		array(3, 3, 5, 6, 3),	
		array(2, 2, 1, 1, 1),
	...
	var $examples3x3 = array(
		array(1, 2, 3),
		array(4, 1, 2),
		array(3, 3, 5),	
	);
	
	var $examples2x2 = array(
		array(2, 6),
		array(7, 8)
	);

	var $examples3x1 = array(
		array(2),
		array(5),
		array(1)
	);
	
	var $examples1x3 = array(
		array(2, 3, 5)
	);
	
	var $examples1x1 = array(
		array(2)
	);	
...
/** Start **/
	...
	function testClean() {
		...
		//pr($is);
		$this->assertEqual($is, $this->examples3x3);
		...
		//pr($is);
		$this->assertEqual($is, $a2);
	}


	function testDim() {	
		$is = $this->Matrix->dimension();
		$this->assertEqual($is, array(3, 3));
	...
	function testGetIdentityMatrix() {
