...
class GeometryLib {
	...
	function circumferenceOfTriangle($a, $b, $c) {
		return $a + $b + $c;
	}
	
	# assuming the triangle is at least isosceled (gleichschenklig)
	function circumferenceOfTriangleByHeight($width, $height) {
	 ...
	 * @return float $area
	 */
	function areaOfTriangleByHeight($width, $height) {
	 ...
	 */
	function heightOfTriangle($a, $b, $c, $returnHeight = null) {
		if ($a == 0 || $b == 0 || $c == 0) {
			return false;
		}
