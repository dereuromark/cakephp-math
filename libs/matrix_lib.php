...
*/
	 ...
	 */
	function getEigenvectors($eigenvalue = null) {
		//TODO
	}
	 ...
	 * 2010-09-16 ms
	 */
	function getIdentityMatrix($size = null) {
		if ($size === null) {
			$size = count($this->matrix);
			if (count($this->matrix[0]) !== $size) {
				return false;
   ...
   */
	 ...
	 * 2010-09-15 ms
	 */
	function dimension($dir = null, $matrix = null) {
		if ($matrix === null) {
			$matrix = $this->matrix;
		}
		$m = count($matrix);
 ...
 /**
   ...
   */
	 ...
	 * vik = (-1)i+k
	 */
	function _determinantForGreater3($array) {
	 ...
	 * 
	 */
	function _bestMatchForLaplace(&$array) {
