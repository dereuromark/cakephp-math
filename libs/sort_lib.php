...
class SortLib {
	...
	function quickSort($array, $start = null, $end = null) {
		if ($start === null) {
			$start = 0;
		}
		if ($end === null) {
	...
	function _merge(&$array,$start,$end,$half)
	{
	...
	function mergeSort($array, $start = null, $end = null) {
		if ($start === null) {
			$start = 0;
		}
		if ($end === null) {
	...
	//TODO: fixme
	function mergeAndSort($Elements1, $Elements2) {
