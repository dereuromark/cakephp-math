 ...
 *
 * $Id: class.hist.php,v 1.1.1.1 2000/02/27 08:36:02 jmcastagnetto Exp $
 */
...
class Histogram {
	...
	public $N,$MIN,$MAX,$AVG,$STDV,$SUM,$SUM2,$NBINS;
	public $BINS = array();
	public $BINGRAPH = array();
	public $STATS = array();

	/* Constructor */

	public function Histogram($data="", $nbins=0, $title="") {
		if ($data && $nbins) {
	...
	public function create($data,$nbins,$title="") {
	...
	public function _printBar($val,$maxbin) {
