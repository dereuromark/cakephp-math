...
class Math_VectorOp {
	 ...
	 */
	public function create ($size, $value) /*{{{*/
	{
		if ($size == 2)
			$VClass = "Math_Vector2";
		elseif ($size == 3)
	 ...
	 * @see	create()
	 */
	public function createZero ($size) 
	{
	 ...
	 * @see	create()
	 */
	public function createOne ($size) /*{{{*/
	{
	 ...
	 * @see	createZero()
	 */
	public function createBasis ($size, $index) /*{{{*/
	{
		if ($index >= $size)
	 ...
	 * @see		isVector3()
	 */
	public function dotProduct ($v1, $v2)/*{{{*/
	{
	 ...
	 * @see		crossProduct()
	 */
	public function tripleScalarProduct ($v1, $v2, $v3) /*{{{*/
	{
	 ...
	 * @return	array
	 */
	public function _fill($index, $size, $value)/*{{{*/
	{
